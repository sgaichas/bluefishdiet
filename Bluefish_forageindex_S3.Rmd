...
knitr::include_graphics("pyindex/2022/allagg_annual_500_lennosst_ALLsplit_biascorrect/ln_density-predicted.png")
```
...
for(p in diagplots){
    ...
    cat(paste0("![Annual diagnostics:",
               p,
               "](pyindex/2022/allagg_annual_500_lennosst_ALLsplit_biascorrect/",
                      p,
                      ".png)")) 
    cat("  \n")   
...
splitoutput <- read.csv("pyindex/2022/allagg_annual_500_lennosst_ALLsplit_biascorrect/Index.csv")
...
The full results of all models are archived on [google drive](https://drive.google.com/drive/folders/1PsEk5hhQ7fR0Gq4NnYPvU4V59d4nIR8E).
