...
for(iepu in 1:length(EPU)){
  ...
  #stratified biomass
  all[variable == 'strat.biomass', Var := paste(SOE.20, SEASON, 'Biomass Index')]
  ...
  #Standard Error
  all[variable == 'biomass.SE', Var := paste(SOE.20, SEASON, 
...
save(survey.data, file = here('data/Aggregate_Survey_biomass_22.RData'))
```
