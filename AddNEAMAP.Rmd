...
This script uses predatar mean length as a catchability covariate, with the option to add number of distinct predator types, and temperature as well.
...
The rationale for including bottom temperature is that predator metabolism and consumption changes with temperature, although this may not be linear depending on the temperature range. 
...
And the offshore axis is perpendicular to the alongshore axis, originating from its center. 
...
#find perpendicular axis at midpoint of alonshore line
