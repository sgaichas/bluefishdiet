...
So add a column mapping pynam to blueprey. Then sum that preywt at each station and divide by n preds using the piscivore dataset. Then that is the input? Expected biomass of prey per piscivore stomach?
