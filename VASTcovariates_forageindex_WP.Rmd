...
Comparisons of AIC are presented for both the first (spatial and spatio-temporal random effects, Table \@ref{tab:mmodsel1}) and second (catchability covariates), Table \@ref{tab:mmodsel2}) rounds of model selection. 
