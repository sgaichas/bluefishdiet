...
Check NA dates: 5 hauls in allfh have no station data, one made it to the bluefish diet database (201202_389) because it has piscivores sampled (cod) but no bluefish prey. I think dropping this one data point with no haul info will not alter the analysis outcome.
...
NEAMAP has station data; 34 records don't merge because latitude is different at the 8th decimal place. We can use the version of latitude that is recommended by the NEAMAP team.
